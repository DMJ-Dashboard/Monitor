...
<head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="1800; url=/dashboard_IKABDG">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu"
                    style="background-color: #233945; border: 1px #bd8b3f; color: white; border-style: solid;">
                                            ...
                                            <span class="info-box-icon" style="background: transparent !important;">
                                                <a href="#">
                                                    <i class="fa-solid fa-hand-holding-dollar"
                                                        style="color: #bd8b3f !important;"></i>
                                                </a>
                                            </span>
